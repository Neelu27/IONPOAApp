...
class OrderPlacedv2 extends React.Component {
            ...
            <View style={{height:width*0.17,backgroundColor:'#EF2929',width:width,alignItems:'center',padding:0}}>
                <View style={{paddingVertical:10,width:width*0.93}}>
                    <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                        ...
                        <Text style={{color:'#fff',fontSize:18,fontWeight:'400',paddingHorizontal:10,paddingTop:15,paddingLeft:width*0.15}}>Order details</Text>
                        <TouchableOpacity onPress={()=>{this.props.navigation.navigate('HelpScreen')}}>
                          <Image source={require('../assets/images/Help.png')} style={{height:22,width:22,marginTop:12}}/>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(OrderPlacedv2);
