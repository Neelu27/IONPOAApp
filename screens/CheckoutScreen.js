...
class CheckoutScreen extends React.Component {
  ...
  constructor(props) {
    ...
    orderDetails=()=>{
      return(
        <View style={[styles.shadow,{borderTopWidth:0,borderBottomWidth:0,padding:15}]}>
          <Text style={{fontSize:16,color:'#000',fontWeight:'400',paddingBottom:10}}>Order details</Text>
    ...
    address=()=>{
      return(
        <TouchableOpacity onPress={()=>{this.props.navigation.navigate('MyAddress',{ onSelect: this.onSelect})}}>
            <View style={[styles.shadow,{borderTopWidth:0,borderBottomWidth:0,padding:15}]}>
              ...
              {this.state.selected==true&&  <Text style={{fontSize:14,color:'#EF2929',fontWeight:'400',paddingBottom:10}}>EDIT</Text>}
            </View>
              {/* <View style={{borderWidth:0.2}}/> */}
       ...
       <Modal isVisible={this.state.model} animationIn="fadeIn" animationOut="fadeOut" hasBackdrop={true} backdropColor={'#3b3b3b'} >
             <View style={[
                   ...
                   <View style={{alignItems:'center',borderWidth:0,alignSelf:'center',padding:6,width:'100%',height:'100%'}}>
                       ...
                       <TouchableOpacity onPress={()=>{this.setState({select:!this.state.select})}} style={{flexDirection:'row',borderWidth:0,marginVertical:10,paddingHorizontal:10,paddingVertical:10,alignItems:'center',justifyContent:'space-between'}}>
                         {!this.state.select?<Image source={require('../assets/images/paymentunchecked.png')} style={{height:22,width:22,marginRight:10}}/>:<Image source={require('../assets/images/select.png')} style={{height:22,width:22,marginRight:10}}/>}
      ...
      <View style={[{flex:1,backgroundColor:'#f5f5f5',}]}>
            ...
            <View style={{height:width*0.17,backgroundColor:'#EF2929',width:width,alignItems:'center',padding:0}}>
                <View style={{paddingVertical:10,width:width*0.93}}>
                    <View style={{flexDirection:'row',alignItems:'center',}}>
                        ...
                        <Text style={{color:'#fff',fontSize:18,fontWeight:'400',paddingHorizontal:10,paddingTop:15,paddingLeft:width*0.15}}>Checkout</Text>
                    </View>
                </View>
            </View>
            ...
            <View style={{position:'absolute',left:0,right:0,bottom:-2,flexDirection:'row'}}>
              <TouchableOpacity style={{flex:0.5,alignSelf:'flex-start',justifyContent:'flex-start',borderTopWidth:0.5,backgroundColor:'#fff',borderColor:'gray'}}>
                <Text style={{paddingVertical:15,fontSize:18,textAlign:'center'}}>&#8377; 700</Text>
              </TouchableOpacity>
              <TouchableOpacity  onPress={()=>{this.pay()}} style={{flex:0.5,alignSelf:'flex-end',justifyContent:'flex-end',borderTopWidth:0.5,backgroundColor:'#033285',borderColor:'#033285'}}>
                <Text style={{paddingVertical:15,fontSize:18,textAlign:'center',color:'#fff'}}>Pay now</Text>
              </TouchableOpacity>
            </View>
            {this.payNow()}
      </View>
