...
myOrder=()=>{
  return(
    <View>
    <TouchableOpacity onPress={()=>{this.props.navigation.navigate('OrderPlacedv2')}}>
      <View style={{height:width*0.25,borderWidth:0,flexDirection:'row',margin:10,padding:10,backgroundColor:'#fff',borderRadius:10}}>
            ...
            <View style={{height:width*0.17,backgroundColor:'#EF2929',width:width,alignItems:'center',padding:0}}>
                <View style={{paddingVertical:10,width:width*0.93}}>
                    <View style={{flexDirection:'row',alignItems:'center',}}>
                        ...
                        <Text style={{color:'#fff',fontSize:18,fontWeight:'400',paddingHorizontal:10,paddingTop:10,paddingLeft:width*0.3}}>My   orders</Text>
                    </View>
                </View>
            </View>
